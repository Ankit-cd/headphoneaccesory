          ...
          <div className='flex flex-col justify-center py-14 md:py-0 xl:max-w-[500px]'>
            <div className='space-y-5 md:text-left text-center'>
              <AnimatePresence mode='wait'>
                <UpdateFollower mouseOptions={{
                  ...
                  <motion.h1
                    ...
                    animate="show"
                    exit="exit"
                    className='text-3xl lg:text-6xl font-bold'>{activeData.title}
              ...
              <AnimatePresence mode='wait'>
                <UpdateFollower
                 mouseOptions={{
                  ...
                  backgroundElement:(
                    <div>
                      <img src={activeData.image} alt="activeimage" />
                    </div>
                  )
                 }}>
                  <motion.button
              ...
              <motion.div
               ...
               className='flex items-center justify-center gap-4 md:justify-start !mt-24'>
               ...
               headphoneData.map((item)=>(
                <UpdateFollower key={item.id} mouseOptions={
                  ...
                  <motion.div
                    ...
                    animate={{opacity:1}}
                    transition={{duration:0.8,delay:0.3}}
                    onClick={()=>handleActiveData(item)} key={item.id} className='grid grid-cols-2 place-items-center cursor-pointer'>
                    <div>
                      <img className='w-[200px]' src={item.image} alt="headphonecover"/>
                    </div>
